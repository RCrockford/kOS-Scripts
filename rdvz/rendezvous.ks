...
if targetPos:Mag > minDist
{
    ...
    Rdvz_TargetApproach(approachPos@, headingVec@, 2 * rcsPerf:thrust / Ship:Mass, max(relV:Mag, min(16 * rcsPerf:thrust / Ship:Mass, 8)), minDist * 0.02).
}
